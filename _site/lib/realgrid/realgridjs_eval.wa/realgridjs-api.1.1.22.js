var RealGridJS = (function () {
    ...
    */
    ...
    var GridView = function (container, accessbility) {
        var readOnly = arguments.length > 1 ? accessbility : false;
        this.base = GridBase;
        this.base();
        _realgrid.createGrid(container, this, accessbility);
    };
    ...
    var TreeView = function (container, accessbility) {
        var accessbility = arguments.length > 1 ? accessbility : false;
        this.base = GridBase;
        this.base();
        _realgrid.createTree(container, this, accessbility);
    };
